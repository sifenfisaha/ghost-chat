  ...
  rooms: [
    {
      ...
      operator: "admin_user",
      systemBanner: "SYSTEM: Ephemeral session established. All data stored in RAM.",
      alert: "Alert: 5 minutes remaining before automatic room purge.",
      assets: [
        { id: "asset-1", name: "auth_handler.rs", meta: "Snippet - 2.4KB", ttl: "01:42", kind: "snippet" },
        {
          id: "asset-2",
        ...
        { id: "asset-3", name: "rsa_public.key", meta: "Key File - 512B", ttl: "00:15", kind: "key" },
      ],
      securityRules: [
        {
      ...
      users: [
        ...
        { id: "user-2", name: "dev_null", state: "Active 2m ago", active: true },
      ...
      footerLatency: "Latency: 24ms",
      footerStatus: "Status: Connected",
      footerVersion: "v2.4.8-stable",
    },
  ],
};
